...
export default function ContactPage() {
  return (
    <main className="mx-auto max-w-[520px] px-5 pt-28 pb-20">
      <p className="text-[11px] uppercase tracking-[0.28em] text-tea font-bold">Nous trouver</p>
      <h1 className="mt-2 font-serif text-[40px] leading-[1.02] tracking-tight">
        Contact & Accès
      </h1>
      ...
      <div className="mt-8 space-y-6">
        ...
        {/* Map Embed */}
        <div className="overflow-hidden rounded-3xl shadow-soft h-[240px] w-full border border-border/40 mt-6">
          <iframe
